...
const SliderCard = ({property,index,slideIndex}) => {
    ...
    const getWidth =(e)=>{
       setWidth(e.target.offsetWidth + 20)
    }
  
    return (
        <div className='font-jost border rounded-lg absolute lg:w-[30%] h-fit transition-transform ease-in duration-300 ' style={{
            left:`${index*width}px`,transform:`translateX(-${slideIndex*35}%) `
            }} onLoad={getWidth}>
